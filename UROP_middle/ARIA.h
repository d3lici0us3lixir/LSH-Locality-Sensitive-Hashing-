...
class ARIA {
public:
	ARIA(uint8_t* pt, uint8_t* ct, uint8_t* key);
	...
	string ARIA_EnCrypt(int round);
	uint8_t PT[16];
	uint8_t KEY[16];
	uint8_t CT[16];
	uint8_t copy_pt[16] = { 0x00, };
	uint8_t rk[13][16] = { 0x00, };
	const uint8_t ARIA_S1[256] = {
