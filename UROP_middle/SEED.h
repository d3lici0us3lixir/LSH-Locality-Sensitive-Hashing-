...
class SEED {
public:
	SEED(uint32_t* Plaintext, uint32_t* Key);
	void int2byte(uint32_t* input, uint8_t* output);
	uint32_t G_fun(uint32_t x);
	void Key_gen(uint32_t* Key);
	void F_fun(uint32_t C, uint32_t D, uint32_t K0, uint32_t K1, uint32_t* E, uint32_t* F);
	string make_return_str(uint32_t* state);
	string SEED_Enc(int i);
	uint8_t S1[256] = {
